...
<body id="container">
	...
	<article class="articulo">
		...
		<section class="seccion">
			...
			<div class="concurso" id="div_name"><p id="concurso_name">Hacking Inofensivo</p></div>

			<div class="features"><div class="spec">Categoría: </div><div class="spec_content" id="div_cat"><p id="pCat">PHP</p></div> <div class="spec"> Dificultad: </div> <div class="spec_content" id="div_dif"><p id="pDif">Avanzado</p></div><div class="spec"> Inicia: </div> <div class="spec_content" id="div_Finic"><p id="pFinic">12/09/12</p></div> <div class="spec"> Termina: </div> <div class="spec_content" id="div_Ffin"><p id="pFfin">20/09/12</p></div> </div>
			<div class="clear"></div>
			<a href="http://www.google.com" id="hashtag"><p id="pHash">#HackBang</p></a>
			
			<br /><br /><br />
			
			<div class="image"><img id="img1" src="images/template/hacking.png" width="700" height="800"  alt="Poster"/></div>
			<div id="div_content">
			<p id="pCont">
	...
	Ut adipiscing nulla sed eros tincidunt elementum malesuada vel metus. Aliquam convallis libero elit, vel eleifend purus. Pellentesque adipiscing mollis sollicitudin. Mauris faucibus varius dictum. Quisque a lorem quam, et imperdiet enim. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Fusce tellus arcu, tempus a scelerisque sit amet, tincidunt vitae elit. Phasellus mi felis, interdum quis elementum non, suscipit at elit. Integer lorem dolor, iaculis posuere viverra non, luctus euismod lectus. Curabitur at purus sit amet felis placerat pharetra. In et felis eros, ut imperdiet leo. Donec interdum malesuada risus quis consectetur. Donec aliquam ornare neque sed ullamcorper. Aliquam tempor magna vitae enim aliquam suscipit.
	...
	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque iaculis adipiscing lectus, ornare elementum augue ornare quis. Ut sed ullamcorper ante. Ut adipiscing dolor nunc. Phasellus sollicitudin lacinia accumsan. Sed turpis tortor, placerat sed lacinia eget, congue quis erat. Ut vestibulum dignissim orci vel ullamcorper. Cras vel tellus quis metus tempus pharetra. Aenean sem nulla, gravida sed aliquam nec, eleifend eget ligula. Quisque purus orci, semper vitae elementum a, scelerisque vel dui. Nullam vitae justo elit, eget congue ligula. Mauris venenatis nunc eu dolor imperdiet auctor. Etiam consequat rhoncus lorem at adipiscing. Aenean ut justo purus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse laoreet dui quis tellus imperdiet consequat in luctus lacus. 
			</p>
			</div>
			<br />
			
			<div class="features"><div class="spec_envia"> Enviado por: </div><div class="remitente"><p id="pEnvia">Akatsuki777</p></div></div>
